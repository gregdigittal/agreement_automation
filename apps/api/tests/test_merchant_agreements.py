...
def test_tito_validate_valid(authed_client):
...
def test_tito_validate_invalid(authed_client):
    res = authed_client.get("/tito/validate?entity_id=aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa")
    assert res.status_code == 200
